...
//ALU BRANCH
`define ALU_EMP 3'b000
`define	ALU_BEQ	3'b001
`define ALU_BNE 3'b010
`define ALU_BLT 3'b011
`define ALU_BGE	3'b100
`define ALU_BLTU	3'b101
`define ALU_BGEU	3'b110
